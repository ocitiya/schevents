  ...
  <div class="q-px-md q-py-xl page">
    <div v-if="Object.keys(data).length > 0">
      <div class="text-center text-primary text-bold">
        <div class="text-body1">{{ data.filmmaker }}</div>
        <div class="text-h5">{{ data.name }}</div>
        <div class="text-body1">Live Streaming</div>
      </div>
        ...
        <div class="">
          <q-card class="q-pa-md" flat>
            <div class="text-bold text-primary">
              <div class="text-body1">{{ data.filmmaker }}</div>
              <div class="text-h5">{{ data.name }}</div>
              <div class="text-body1">On Show</div>
            </div>
  ...
  methods: {
    ...
    getData: function () {
      ...
      return new Promise((resolve, reject) => {
        let endpoint = `movie/detail/${this.id}`
