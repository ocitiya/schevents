              ...
              <div class="row">
                ...
                <div class="col-7">
                  <div class="form-check form-switch">
                    <input class="form-check-input" type="checkbox" role="switch" id="is_active" name="is_active" <?php echo ($data->is_active == 1) ? "checked" : null ?>>
                  </div>
                </div>
              </div>
            @endif
