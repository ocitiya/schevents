  ...
  <div id="user" class="content">
    ...
    <div class="data-container" style="border: unset">
      <div class="data-header">
        <a href="{{ route('admin.app.contact_us.update') }}" class="btn btn-primary btn-sm unrounded">
          Edit&nbsp;
      ...
      <div class="data-center">
        @if (isset($data))
          <div class="text-center mb-4">
            ...
            @else
              <img src="{{ "/storage/app_contact_us/image/{$data->logo}" }}" style="max-width: 100%; width: 250px;">
            @endif
          </div>
        @endif
