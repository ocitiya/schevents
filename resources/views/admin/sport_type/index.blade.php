...
@section('content')
  <div id="sport_type" class="content">
    <div class="title-container">
      <h4 class="text-primary">Sport Type</h4>
          ...
          @forelse ($types as $item)
            <div class="card text-center shadow-sm">
              ...
              <div class="card-footer text-muted">
                <a
                  href="{{ route('admin.sport.type.detail', ['id' => $item->id]) }}"
                ...
                <a
                  href="{{ route('admin.sport.type.update', ['id' => $item->id]) }}"
                  class="btn btn-primary btn-sm"
                >
                  Edit&nbsp;
...
@section('script')
  <script>
    const deleteURL = "<?php echo route('admin.sport.type.delete') ?>"
    ...
    $('#sport_type').on('click', '.delete-item', function(e) {
