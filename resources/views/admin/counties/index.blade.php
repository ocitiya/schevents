  ...
  <div id="counties" class="content">
    ...
    <div class="data-container">
      ...
      <div class="data-center">
        <div class="data-list" id="county-items">
          {{-- Dynamic Data --}}
        </div>
      </div>
...
@section('script')
  <script>
    ...
    const createCountyItem = (data) => {
      const detailRoute = `/admin/location/counties/detail/${data.id}`
    ...
    const getList = async ({ page = pagination.page, limit = pagination.limit, search = pagination.search } = {}) => {
      ...
      if (data.list.length > 0) {
        data.list.map(item => createCountyItem(item))
      } else {
        $('#county-items').text('No Data')
      }
