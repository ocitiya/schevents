...
@section('content')
  <div id="lp" class="content">
    <div class="title-container">
      <h4 class="text-primary">LP Movie</h4>

      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item" aria-current="page">
            <a href="{{ route('admin.lp.movie.index') }}">Index</a>
          </li>
    ...
    <div class="data-container">
      <div class="data-header">
        <h5 class="text-primary">
          @if(!isset($data))
            <span>Tambah LP Movie</span>
          @else
            <span>Ubah LP Movie {{ $data->name }}</span>
          @endisset
        </h5>
      </div>
      ...
      <div class="data-center">
        ...
        <form
          action="{{ route('admin.lp.movie.store') }}"
          method="POST"
          autocomplete="off"
