...
<body>
  <div class="content">
    <div class="c2">
      ...
      <div class="card-score" data-bs-toggle="modal" data-bs-target="#alertModal">
        <div
        ...
        <div class="tab-content" id="myTabContent">
          ...
          <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
            <p class="mt-2" style="text-align: justify">
              ...
              To watch videos, click <a href="{{ $stream_url }}"><b>Watch Event</b></a> button to watch. 
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="alertModalLabel">Attention</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body m-body">
          <div>
            You must sign in to play this video. <a href="{{ $stream_url }}" target="__blank">Please click here to sign in</a>
          </div>
        </div>
