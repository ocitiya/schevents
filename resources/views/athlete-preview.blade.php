...
<body>
      ...
      <div class="card-score">
        ...
        >
          ...
          <div class="left">
            <div>
              <div class="text-center">
                <img src="{{ asset("storage/athlete/image/{$data->athlete1->image}") }}" width="40%">
              </div>
              <div class="text-center mt-2" style="line-height: 1;">
                <b>{{ $data->athlete1->name }}</b>
              </div>
            </div>
          </div>
          ...
          <div class="right">
            <div>
              <div class="text-center">
                <img src="{{ asset("storage/athlete/image/{$data->athlete2->image}") }}" width="40%">
              </div>
              <div class="text-center mt-2" style="line-height: 1;">
                <b>{{ $data->athlete2->name }}</b>
              </div>
            </div>
          </div>
        ...
        <div class="section footer">
          Watch: {{ $data->athlete1->name }} vs {{ $data->athlete2->name }} - 
          <span class="time"></span> - 
          <span class="date"></span> - 
  ...
  <script>
    ...
    const athlete1 = "<?php echo $athlete1 ?>";
    const athlete2 = "<?php echo $athlete2 ?>";
